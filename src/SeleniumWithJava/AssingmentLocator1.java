...
public class AssingmentLocator1 {
	...
	public static void main(String[] args) {
       ...
       // Women title isDisplayed() ? 
	    ...
	    // T-shirts
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
		boolean tshirtsTitle = driver.findElement(By.xpath("//*[@id=\"block_top_menu\"]/ul/li[1]/ul/li[1]/ul/li[1]/a")).isDisplayed();
		...
		// getSize()
		System.out.println("the size of the first image is :" + driver.findElement(By.xpath("//*[@class='bx-viewport']")).getSize());
		
		//getLocation()			
		System.out.println("the location of first image is :" + driver.findElement(By.xpath("//*[@class='bx-viewport']")).getLocation());
	 ...
	 // get color of second image
	   ...
	   // getSize()
		System.out.println("the size of the 3daySaleImage is :" + driver.findElement(By.xpath("//*[@id=\"htmlcontent_top\"]/ul/li[1]/a/img")).getSize());
				
		//getLocation()			
		System.out.println("the location of 3daySaleImage is :" + driver.findElement(By.xpath("//*[@id=\"htmlcontent_top\"]/ul/li[1]/a/img")).getLocation());
		...
		// getSize()
		System.out.println("the size of the onlyOnlineSummerimage is :" + driver.findElement(By.xpath("//*[@id=\"htmlcontent_top\"]/ul/li[2]/a/img")).getSize());
						
		//getLocation()			
		System.out.println("the location of onlyOnlineSummer image is :" + driver.findElement(By.xpath("//*[@id=\"htmlcontent_top\"]/ul/li[2]/a/img")).getLocation());
